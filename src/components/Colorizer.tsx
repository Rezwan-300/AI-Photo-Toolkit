...
import { Download, Palette, Info, Loader2 } from 'lucide-react';
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        <div className="flex-1 space-y-6">
          <div className="bg-neutral-900/60 border border-neutral-800 p-6 rounded-3xl">
            ...
            <p className="text-neutral-400 mb-6">Bring your old black and white memories back to life.</p>
          ...
          <div className="bg-neutral-900/60 border border-neutral-800 p-6 rounded-3xl">
            ...
            <ul className="space-y-4 text-sm text-neutral-400">
              <li className="flex gap-2">
                ...
                Use high-resolution scans of old photos.
              </li>
              <li className="flex gap-2">
                <span className="text-blue-400">•</span>
                Ensure the photo is not too damaged or blurry.
              </li>
              <li className="flex gap-2">
                <span className="text-blue-400">•</span>
                Works best on portraits and landscapes.
              </li>
            </ul>
          </div>
        </div>
